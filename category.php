...
";
                                        ...
                                        <div class="inner-content clearfix">
                                            ...
                                            <div class="post-information">
                                                ...
                                                <span>
                                                    ...
                                                    <a href='author.php?uid=<?php echo $row['user_id'] ?>'> <?php
                                                                            if ($row['role'] == 1) {
                                                                                echo "Admin";
                                                                            } else {
                                                                                echo $row['username'];
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li><a href="category.php?cid=' . $category_id .  '&page=' . ($page - 1) . '">Prev</a></li>';
                        }
                        ...
                        if ($page < $totalPage) {
                            echo '<li><a href="category.php?cid=' . $category_id .  '&page=' . ($page + 1) . '">Next</a></li>';
                        }
