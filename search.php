...
?>
<h2 class="page-heading">Search - <?php echo $search_word ?></h2>
<?php
                    $limit = 3;
                    if (isset($_GET['page'])) {
                        $page = $_GET['page'];
...
LEFT JOIN user ON post.author = user.user_id
                     WHERE title LIKE '%{$search_word}%' or description LIKE '%{$search_word}%'
                                        ...
                                        <div class="inner-content clearfix">
                                            ...
                                            <div class="post-information">
                                                ...
                                                <span>
                                                    ...
                                                    <a href='author.php?uid=<?php echo $row['user_id'] ?>'><?php if ($row['username'] == "ishu01") {
                                                                                                                echo "Admin";
                                                                                                            } else {
                                                                                                                echo $row['username'];
                                                                                                            } ?></a>
...
";
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li><a href="search.php?search=' . $search_word .  '&page=' . ($page - 1) . '">Prev</a></li>';
                        }
