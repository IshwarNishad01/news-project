                    ...
                    <div class="col-md-offset-4 col-md-4">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                            <div class="form-group">
                                <input type="hidden" value="<?php echo $row['user_id'] ?>" name="user_id" class="form-control" value="1" placeholder="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" value="<?php echo $row['role'] ?>" name="role" value="<?php echo $row['role']; ?>">
                                    <?php
                                    if ($row['role'] == 1) {
